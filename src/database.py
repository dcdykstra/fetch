...
def load_model1_rewards_receipts_items(conn):
    ...
    SELECT 
        ...
        rewardsReceiptItemListExpanded::JSON->>'$.originalFinalPrice' as original_final_price,
        rewardsReceiptItemListExpanded::JSON->>'$.originalMetaBriteBarcode' as original_metabrite_barcode,
        rewardsReceiptItemListExpanded::JSON->>'$.originalMetaBriteDescription' as original_metabrite_description,
        rewardsReceiptItemListExpanded::JSON->>'$.originalMetaBriteItemPrice' as original_metabrite_item_price,
        rewardsReceiptItemListExpanded::JSON->>'$.originalMetaBriteQuantityPurchased' as original_metabrite_quantity_purchased,
        rewardsReceiptItemListExpanded::JSON->>'$.originalReceiptItemText' as original_receipt_item_text,
